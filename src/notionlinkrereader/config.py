...
DEFAULT_DATABASE_ID = "247c3757391080a58f77cbf271b33221"
...
def load_config(env: dict[str, str] | None = None) -> Config:
    ...
    ``NOTION_DATABASE_ID`` defaults to the known database id when unset.
    """
    source = os.environ if env is None else env

    database_id = (source.get("NOTION_DATABASE_ID") or "").strip() or DEFAULT_DATABASE_ID
