# notion-link-selection Specification

## Purpose

Query the configured Notion database, normalize its rows into link records, and select up to three at random for rereading.
